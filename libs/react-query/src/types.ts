/**
 * Type definitions for `@cleverbrush/react-query`.
 *
 * These types map an API contract (from `@cleverbrush/server/contract`) to
 * a typed query client whose groups and endpoints expose TanStack Query
 * hooks (`useQuery`, `useSuspenseQuery`, `useInfiniteQuery`, `useMutation`)
