...
export default function ReadonlySection() {
    return (
        <div className="card">
            ...
            <a href="/playground/readonly-modifier" className="playground-link">
                ▶ Open in Playground
            </a>
            <p>
                Every schema builder supports <code>.readonly()</code>. This is
                a <strong>type-level-only</strong> modifier — it marks the
                inferred TypeScript type as immutable, but does not alter
                validation behaviour or freeze the validated value at runtime.
            </p>
                ...
                <table className="api-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <code>{'Readonly<{ … }>'}</code> — all top-level
                                properties become <code>readonly</code>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <code>push</code>, <code>pop</code>, etc. at the
                                type level
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <code>number</code>, <code>boolean</code> are
                                already immutable
                            </td>
                        </tr>
                    </tbody>
...
console.log(schema.introspect().isReadonly); // true`)
            ...
            <p>
                ...
                <strong>shallow</strong> — only top-level object properties or
                the array itself are marked readonly. For deeply nested
