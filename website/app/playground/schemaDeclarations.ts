...
export {};
`,
    "file:///node_modules/@cleverbrush/schema/builders/InterpolatedStringSchemaBuilder.d.ts": `import { ObjectSchemaBuilder } from './ObjectSchemaBuilder.js';
 ...
 */
export type InterpolatedTemplateTag<TSchema extends ObjectSchemaBuilder<any, any, any, any, any, any, any>> = (strings: TemplateStringsArray, ...selectors: Array<(tree: PropertyDescriptorTree<TSchema, TSchema, string | number | boolean | Date>) => PropertyDescriptor<TSchema, any, any>>) => InterpolatedTemplateDefinition;
type InterpolatedStringSchemaBuilderCreateProps<T = any, R extends boolean = true> = Partial<ReturnType<InterpolatedStringSchemaBuilder<T, R>['introspect']>>;
/**
 ...
 */
export declare class InterpolatedStringSchemaBuilder<TResult = any, TRequired extends boolean = true, TNullable extends boolean = false, THasDefault extends boolean = false, TExtensions = {}> extends SchemaBuilder<TResult, TRequired, TNullable, THasDefault, TExtensions> {
    #private;
    /**
     * @hidden
     */
    static create(props: InterpolatedStringSchemaBuilderCreateProps): InterpolatedStringSchemaBuilder<any, true, false, false, {}>;
    ...
    introspect(): {
        ...
        templateDefinition: InterpolatedTemplateDefinition;
        type: string;
        isRequired: boolean;
        isNullable: boolean;
        isReadonly: boolean;
     ...
     * @inheritdoc
     */
    hasType<T>(_notUsed?: T): InterpolatedStringSchemaBuilder<T, true, TNullable, THasDefault, TExtensions> & TExtensions;
    /**
     * @inheritdoc
     */
    clearHasType(): InterpolatedStringSchemaBuilder<any, TRequired, TNullable, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    nullable(): InterpolatedStringSchemaBuilder<TResult, TRequired, true, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    notNullable(): InterpolatedStringSchemaBuilder<TResult, TRequired, false, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    required(errorMessage?: ValidationErrorMessageProvider): InterpolatedStringSchemaBuilder<TResult, true, TNullable, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    optional(): InterpolatedStringSchemaBuilder<TResult, false, TNullable, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    default(value: TResult | (() => TResult)): InterpolatedStringSchemaBuilder<TResult, true, TNullable, true, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    clearDefault(): InterpolatedStringSchemaBuilder<TResult, TRequired, TNullable, false, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    brand<TBrand extends string | symbol>(_name?: TBrand): InterpolatedStringSchemaBuilder<TResult & {
        readonly [K in BRAND]: TBrand;
    }, TRequired, TNullable, THasDefault, TExtensions> & TExtensions;
    /**
     * @hidden
     */
    readonly(): InterpolatedStringSchemaBuilder<Readonly<TResult>, TRequired, TNullable, THasDefault, TExtensions> & TExtensions;
    protected createFromProps<T, TReq extends boolean>(props: InterpolatedStringSchemaBuilderCreateProps<T, TReq>): this;
}
/**
 ...
 */
export declare function interpolatedString<TSchema extends ObjectSchemaBuilder<any, any, any, any, any, any, any>>(objectSchema: TSchema, templateBuilder: ($template: InterpolatedTemplateTag<TSchema>) => InterpolatedTemplateDefinition): InterpolatedStringSchemaBuilder<InferType<TSchema>>;
export {};
`,
...
export { InterpolatedStringSchemaBuilder, interpolatedString } from './builders/InterpolatedStringSchemaBuilder.js';
...
export {};
`,
    "file:///node_modules/@cleverbrush/schema/index.d.ts": `export type { InterpolatedTemplateTag } from './builders/InterpolatedStringSchemaBuilder.js';
export { InterpolatedStringSchemaBuilder, interpolatedString } from './builders/InterpolatedStringSchemaBuilder.js';
export { LazySchemaBuilder, lazy } from './builders/LazySchemaBuilder.js';
