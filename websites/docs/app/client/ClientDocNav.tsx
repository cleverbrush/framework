...
import { CLIENT_SECTIONS, SECTION_GROUPS } from './sections/index';
...
export function ClientDocNav({ currentSlug, collapsed, onToggle }: Props) {
                    ...
                    {SECTION_GROUPS.map(group => (
                        <div key={group.label} className="pg-nav-group">
                            ...
                            {group.slugs.map(slug => {
                                const section = CLIENT_SECTIONS.find(
                                    s => s.slug === slug
                                );
