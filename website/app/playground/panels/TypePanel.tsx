            ...
            <div className="pg-panel pg-type-panel">
                ...
                <div className="pg-type-placeholder">
                    ...
                    <p className="pg-type-hint">
                        <code>InferType&lt;typeof schema&gt;</code> automatically derives the
                        TypeScript type from your schema definition.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="pg-panel pg-type-panel">
            ...
            <div className="pg-type-note">
                Types update automatically as you modify the schema.
                Required fields lose <code>| undefined</code>, branded types get phantom tags.
            </div>
        </div>
    );
}
