        ...
        <>
            <div className="card">
                ...
                <p>
                    ...
                    without modifying the core library. Define an extension
                    once, apply it with <code>withExtensions()</code>, and every
                    builder produced by the returned factories includes your new
...
const ServerConfig = s.object({
  ...
  name: s.string().minLength(1)
                ...
                <p>
                    ...
                    argument, and multi-arg methods store the arguments array:
                </p>
                <pre>
                    <code
                        // biome-ignore lint/security/noDangerouslySetInnerHtml: allow here
...
console.log(rangeSchema.introspect().extensions.range); // [0, 100]`)
                ...
                <p>
                    ...
                    explicitly. The auto-infer logic detects the existing key
                    and skips automatic attachment:
                </p>
                <pre>
                    <code
                        // biome-ignore lint/security/noDangerouslySetInnerHtml: allow here
        ...
        .addValidator((val) => {
          ...
          return { valid, errors: valid ? [] : [{ message: \`Max \${maxDec} decimal places\` }] };
                ...
                <p>
                    ...
                    extensions add <strong>named, discoverable methods</strong>{' '}
                    to the builder API with full TypeScript autocompletion.
                    Unlike Joi&apos;s <code>.extend()</code>, extension methods
                    are type-safe and composable without any casts.
                </p>
                <p>
                    We encourage the community to create and publish extensions
                    for common use cases — email validation, currency
                    formatting, URL slugs, phone numbers, and more. A well-typed
                    extension is just a <code>defineExtension()</code> call
                    away.
                </p>
            </div>
        </>
