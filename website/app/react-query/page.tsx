        ...
        <div className="page">
            <div className="container">
                <div className="section-header">
                    <h1>@cleverbrush/react-query</h1>
                    <p className="subtitle">
                        Unified typed client — direct fetch and TanStack Query
                        hooks on the same object. Zero codegen, full type
                        safety.
                    </p>
                </div>
                ...
                {/* ── Installation ─────────────────────────────────── */}
                <InstallBanner
                    command="npm install @cleverbrush/react-query @tanstack/react-query"
                    note={
                        <>
                            Requires <code>@cleverbrush/web</code>,{' '}
                ...
                <div className="why-box">
                    <h2>💡 Why @cleverbrush/react-query?</h2>

                    <h3>The Problem</h3>
                    <p>
                        Using TanStack Query with typed API clients means
                        manually writing <code>queryKey</code> arrays,{' '}
                        <code>queryFn</code> wrappers, and mutation boilerplate
                        for every endpoint. Query keys are stringly-typed and
                        fragile — rename an endpoint and your invalidation logic
                        silently breaks.
                    </p>

                    <h3>The Solution</h3>
                    <p>
                        <code>@cleverbrush/react-query</code> wraps your{' '}
                        <code>defineApi()</code> contract in a unified client
                        where every endpoint is both a callable function (direct
                        fetch) and an object with TanStack Query hooks. Query
                        keys are hierarchical and deterministic — invalidate a
                        single entry, an entire endpoint, or a whole group with
                        one call. One import, zero boilerplate.
                    </p>
                </div>
                ...
                <div className="card">
                    ...
                    <pre
                        dangerouslySetInnerHTML={{
                            __html: highlightTS(`import { createClient } from '@cleverbrush/react-query';
...
export const client = createClient(api, {
    baseUrl: 'https://api.example.com',
                    ...
                    <pre
                        dangerouslySetInnerHTML={{
                            __html: highlightTS(`// Direct fetch (same as @cleverbrush/web)
        ...
        <ul>
            {data?.map(t => <li key={t.id}>{t.title}</li>)}
                    ...
                    <table className="api-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Standard TanStack Query hook with
                                    auto-generated key and fetch function
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    Suspense-enabled query — suspends the
                                    component until data is ready
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <code>
                                        useInfiniteQuery(argsFn, options)
                                    </code>
                                </td>
                                <td>
                                    Infinite scrolling with a function that
                                    receives <code>pageParam</code>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Returns the query key array for cache
                                    operations
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Prefetches data into the TanStack query
                                    cache
                                </td>
                            </tr>
                        </tbody>
                ...
                <div className="card">
                    ...
                    <p>
                        Query keys follow a predictable hierarchy for
                        fine-grained or bulk invalidation:
                    </p>
                    <pre
                        dangerouslySetInnerHTML={{
        ...
        <Suspense fallback={<p>Loading…</p>}>
            <TodoListSuspense />
                ...
                <div className="card">
                    <h2>Prefetching</h2>
                    <p>
                        Pre-populate the cache before a component mounts — great
                        for hover-to-prefetch patterns:
                    </p>
                    <pre
                        dangerouslySetInnerHTML={{
    ...
    View Todo
                ...
                <div className="card">
                    ...
                    <p>
                        ...
                        <code>@cleverbrush/web</code>. Use the provided type
                        guards:
                    </p>
                    <pre
                        dangerouslySetInnerHTML={{
                            __html: highlightTS(`import { isApiError, isTimeoutError } from '@cleverbrush/web';
...
function TodoList() {
    ...
    return <ul>{data?.map(t => <li key={t.id}>{t.title}</li>)}</ul>;
                ...
                <div className="card">
                    <h2>Key Utilities</h2>
                    <p>
                        For manual key construction outside of the proxy (e.g.,
                        in SSR loaders or utility functions):
                    </p>
                    <pre
                        dangerouslySetInnerHTML={{
