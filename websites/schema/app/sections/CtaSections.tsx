                ...
                <div className="container">
                    <div className="contribute-banner">
                        <div className="contribute-content">
                            ...
                            <p>
                                The same schemas power a full web framework —
                                type-safe server endpoints, auto-typed clients,
                                OpenAPI spec generation, auth, and DI — all
                                derived from one schema definition. Zero
                                duplication, zero type drift.
                            </p>
