...
import { WEB_SECTIONS } from '../sections/index';
...
import { WebDocLayout } from './WebDocLayout';

export function generateStaticParams() {
    return [{ slug: [] }, ...WEB_SECTIONS.map(s => ({ slug: [s.slug] }))];
}
...
export default async function WebDocPage({
    params
}: {
    ...
    return (
        <WebDocLayout currentSlug={currentSlug}>
            <SectionComponent />
        </WebDocLayout>
    );
}
