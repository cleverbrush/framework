...
export default function DefaultValuesSection() {
    return (
        <div className="card">
            ...
            <a href="/playground/default-values" className="playground-link">
                ▶ Open in Playground
            </a>
            <p>
                Every schema builder supports <code>.default(value)</code>. When
                the input is <code>undefined</code>, the default value is used
...
// All fields are non-optional — defaults fill in missing values`)
            ...
            <p>
                ...
                making them available for form generation, serialization, and
                other tooling:
            </p>
            <pre>
                <code
