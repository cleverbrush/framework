    ...
    return (
        <>
            <div className="card">
                ...
                <p>
                    Every schema builder supports <code>.describe(text)</code>.
                    This attaches a human-readable description to the schema as{' '}
                    ...
                    emitted as the <code>description</code> field by{' '}
                    <code>toJsonSchema()</code> (including nested properties).
                </p>
                    ...
                    <table className="api-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    The text passed to <code>.describe()</code>,
