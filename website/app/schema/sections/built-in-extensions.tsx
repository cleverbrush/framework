        ...
        <>
            <div className="card">
                ...
                <p>
                    ...
                    validators. You get these methods automatically — no extra
                    setup required:
                </p>
                ...
                <p>
                    All validator extensions accept an optional error message as
                    the last parameter — either a string or a function (matching
                    the same <code>ValidationErrorMessageProvider</code> pattern
                    used by built-in constraints like <code>.minLength()</code>
                    ):
                </p>
                <pre>
                    <code
...
const score = number().multipleOf(5, (val) => \`\${val} is not a multiple of 5\`);`)
                ...
                <p>
                    ...
                    extensions), import from the <code>/core</code> sub-path:
                </p>
                <pre>
                    <code
                        // biome-ignore lint/security/noDangerouslySetInnerHtml: allow here
...
const s = withExtensions(myCustomExtension);`)
                ...
                <p>
                    ...
                    <code>/core</code> and overrides the nine factory functions
                    with pre-extended versions. The extension descriptors
                    themselves (<code>stringExtensions</code>,{' '}
                    <code>numberExtensions</code>, <code>arrayExtensions</code>)
                    are also exported so you can compose them with your own.
                </p>
            </div>
        </>
    );
